...
.color-info-panel .panel-header {
  display: flex;
  justify-content: end;
}

.color-info-panel .panel-header .close-button {
  font-size: 20px;
  cursor: pointer;
  font-weight: bold;
  color: #4f4f4f;
...
.color-info-panel .colors {
  display: flex;
  justify-content: space-around;
}

.color-info-panel .colors .color-button {
...
.color-info-panel .colors .color-button:checked {
  outline: 2px solid white;
  border: 2px solid black;
}

.color-info-panel .colors-info {
  display: flex;
  flex-direction: column;
  align-items: center;
}

.color-info-panel .colors-info .color-parameter {
  /* margin-top: 10px; */
  height: 35px;
}

.color-info-panel .colors-info .color-parameters {
  width: 100%;
  display: flex;
  justify-content: space-around;
}
.color-info-panel .contrast {
  text-align: center;
}
